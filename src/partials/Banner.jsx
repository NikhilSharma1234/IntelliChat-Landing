    ...
    <>
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-60">
          <div className="bg-[#277EFF] text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-white inline-flex">
              <a className="font-medium hover:underline text-white" href="https://chrome.google.com/webstore" target="_blank" rel="noreferrer">
